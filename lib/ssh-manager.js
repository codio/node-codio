...
SshManager.prototype.verifyServer = function (session, uid, callback) {
    var self = this;
    var data = {};
    if (uid) {
        data.uid = uid;
    }
    this.requestSigned('verifyServer', data, {
        'session_id' : session
    }, function (error, data) {
        if (!error) {
...
SshManager.prototype.getSshConnectDetails = function (userName, container, callback) {
    var self = this;
    this.requestSigned('getContainerSsh', {
        container: container,
        userName: userName
    }, {
    }, function (error, data) {
...
SshManager.prototype.getHostDetailsBySsh = function (host, port, callback) {
    this.requestSigned('getHostDetailsByExternalSsh', {
        host: host,
        port: port
    }, {},
    function (error, data) {

...
OrganizationManager.prototype.getById = function (id, session, callback) {
...
// session  - String, the session key.
// callback - A callback function.
OrganizationManager.prototype.getByName = function (name, session, callback) {
...
// callback - A callback function.
OrganizationManager.prototype.createTeam = function (name, info, callback) {
...
// session      - String, the session key.
// callback     - A callback function.
OrganizationManager.prototype.getTeamByName = function (organization, name, session, callback) {
...
// session  - String, the session key.
// callback - A callback function.
OrganizationManager.prototype.getMyOrganizations = function (session, callback) {
...
// session      - String, the session key.
// callback     - A callback function.
OrganizationManager.prototype.isMemberOf = function (organization, teams, session, callback) {

    assert.string(organization, 'organization');
    assert.arrayOfString(teams, 'teams');
    assert.string(session, 'session_id');
    assert.func(callback, 'callback');

    this.request('isMemberOf', {

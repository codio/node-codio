...
// Get a the organizations according to the given info data
//
// data     - object, must contain or "id" or "name"
//
// Returns a promise.
OrganizationManager.prototype.getOrganizationInternal = function (data) {
    return this.signed('getOrganizationInternal', data, {});
};
...
OrganizationManager.prototype.createTeam = function (name, info) {
    ...
    return this.request('createTeam', {
        name: name,
        orgId: info.org,
...
//
// Returns a promise.
OrganizationManager.prototype.getUserOrganizations = function (userId, session) {

    assert.string(userId, 'id');
    assert.string(session, 'session_id');

    return this.signed('getUserOrganizations', {
        userId : userId
    }, {
        'session_id' : session
    });

...
// Add members to the given team with updating users status.
//
// data     - Object,
// session  - String, the session key.
//
// Returns a promise.
OrganizationManager.prototype.addStudents = function (data, session) {
    ...
    return this.signed('addStudents', data, {
        'session_id' : session
    });
};
...
//
// Returns a promise.
OrganizationManager.prototype.addTeachers = function (data, session) {
    ...
    return this.signed('addTeachers', data, {
        'session_id' : session
    });
};

...
OrganizationManager.prototype.getOrganizationTeams = function (organization, session, withMembers) {
    assert.string(organization, 'organization');
    assert.optionalBool(withMembers, 'withMembers');
    assert.string(session, 'session_id');


    return this.request('getOrganizationTeams', {
        id: organization,
...
OrganizationManager.prototype.sendInvitation = function (orgId, email, isOwner, session) {
    ...
    return this.request('sendInvitation', {
...
OrganizationManager.prototype.resendInvitation = function (orgId, invitation, session) {

    assert.string(orgId, 'org id');
    assert.string(invitation, 'invitation');
    assert.string(session, 'session_id');

    return this.request('resendInvitation', {
        organization: orgId,
        invite: invitation
    }, {
        'session_id': session
...
OrganizationManager.prototype.revokeInvitation = function (orgId, invitation, session) {

    assert.string(orgId, 'org id');
    assert.string(invitation, 'invitation');
    assert.string(session, 'session_id');

    return this.request('revokeInvitation', {
        organization: orgId,
        invite: invitation
    }, {
        'session_id': session
...
OrganizationManager.prototype.getInvites = function (orgId, session) {

    assert.string(orgId, 'org id');
    assert.string(session, 'session_id');

    return this.request('getInvites', {
        organization: orgId
    }, {
        'session_id': session
    });

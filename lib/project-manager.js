...
//
// guids      - Array, projects guids
// isDisabled - Boolean, is projects disabled or not
//
// Returns a promise.
ProjectManager.prototype.setProjectsDisabled = function (guids, isDisabled) {
    assert.arrayOfString(guids, 'guids');
    assert.bool(isDisabled, 'is_disabled');

    return this.requestSigned('setProjectsDisabled', {
        guids: guids,

...
// Set a list of projects by guids as Free
//
// guids    - array of project ids
// isFree   - boolean
//
// Returns a promise.
ProjectManager.prototype.setProjectsFree = function (guids, isFree) {
    assert.arrayOfString(guids, 'guids');
    assert.bool(isFree, 'isFree');

    return this.requestSigned('setProjectsFree', {
        guids: guids,
        is_free: isFree
    }, {});
};

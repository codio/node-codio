...
//
// Returns a promise.
ProjectManager.prototype.changeStackInternal = function (ids, stack, replyParameters) {
  assert.arrayOfString(ids, 'ids');
  assert.string(stack, 'stack');
  return this.requestSigned('changeStackInternal', {ids: ids, stack: stack, replyParameters: replyParameters}, {})
    .then(function (data) {
      return data.message;
    });
};
...
function request(options, object, method, data, params, callback) {
    var cookie = '';
    var serverUrl = null;
    try {
    ...
    var req = client.request(reqOptions, function (response) {
        ...
        response.on('end', function () {
            if (response.statusCode !== 200) {
                ...
                try {
                    ...
                    if (parsedResponse.hasOwnProperty('response') && parsedResponse.code === 1) {
...
function pingTaskStatus(options, taskId, params, callback) {
    var pingTimeout;

    function ping() {
        request(options, 'TaskManager', 'getTaskStatus', {id: taskId},

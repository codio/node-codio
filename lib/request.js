...
function createDone(pathname, object, method, withHeaders) {
    return function done(res) {
        ...
        return withHeaders ? {headers: res.headers, response: result.response} : result.response;
    };
}
...
module.exports = function request(options, object, method, data, params, shouldSign) {
    ...
    return req.postAsync({
        ...
        headers: headers,
        body: acrequest
    }).then(createDone(pathname, object, method, options.withHeaders));
};
